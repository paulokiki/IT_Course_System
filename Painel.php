...
//--------------------------------------------------------------------------------------------
                    ...
                    include "Lista.php";    } 
                        ...
                        include "InfoFornecedores.php";
                    }
                    else if ($idPg == 32){
                        include "FormCadastroFornecedores.php";
                        }
...
//--------------------------------------------------------------------------------------------
                    ...
                    //Transportadoras
                        ...
                        //informações transportadoras
                    }

                    else if ($idPg == 42) {
                        //formcadastroTransportadoras
                    include "formcadastroTransportadoras.php";
...
//--------------------------------------------------------------------------------------------
                    ...
                    //Vendas
                        ...
                        //Informações de vendas
                                ...
                                include "FormCadastroVendas.php";
                    }
